...
st.sidebar.image("https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=facearea&w=256&q=80", width=80)
...
st.image("https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif", width=350)  # Animated line chart GIF
st.markdown("""
...
if df is not None and not df.empty:
    ...
    with tabs[5]:
        ...
        if 'model' in st.session_state and 'X_test' in st.session_state and 'y_test' in st.session_state:
            ...
            st.image("https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif", width=300)  # Animated line chart GIF
        else:
